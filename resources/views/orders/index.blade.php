...
<div class="row">
  <div class="col-lg-10 col-lg-offset-1">
      ...
      <h1 class="authHeaders">@fa('archive',['class' => 'faIcons ']) Orders </h1>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li>
                          <a href="/orders/{{$order->id}}/accept">
                            @fa('check', ['class' => 'faIcons']) Accept order
                          </a>
                        </li>
                        @else
                        <li>
                          <a href="/orders/{{$order->id}}/reject">
                            @fa('ban', ['class' => 'faIcons']) Reject order
                          </a>
                        </li>
                        @endif
                        <li>
                          {{ Form::open(['url' => '/orders/' . $order->id, 'method' => 'DELETE', 'id' => 'delUserForm']) }}
